...
/**
 * REST request payload used to update the details and active status of an existing
 * course.
 */
@Data
@Schema(description = "Payload for updating an existing course")
public class UpdateCourseResource {
	...
	@NotNull(message = "Active status must be explicitly provided")
	@Schema(description = "The active status of the course", example = "true")
